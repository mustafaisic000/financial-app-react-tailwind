        ...
        <>
          <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 lg:px-12 xl:m-auto">
            <div className="flex">
              ...
              <div className="ml-4 flex hidden items-center space-x-4 sm:ml-6 sm:flex lg:ml-8 lg:space-x-8">
            ...
            <ButtonLink
              ...
              className="active:bg hidden rounded-xl bg-gray-800 px-5 py-3 text-white hover:bg-gray-900
              active:bg-gray-600 sm:flex"
            />
            <Disclosure.Button className="hover: rounded-md p-2 text-gray-500  hover:bg-gray-700 hover:text-white sm:hidden">
              {open ? (
